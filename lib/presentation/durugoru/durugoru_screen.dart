            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(ref.read(l10nProvider).backButton, style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500)),
                ],
              ),
            ),
          ),
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Center(
            child: Text(ref.watch(l10nProvider).durugoruTitle,
