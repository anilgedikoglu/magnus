...
namespace ScratchCardAsset
{
	public class ScratchCardManager : MonoBehaviour
	{
		...
		void Awake()
		{
            ...
            if (chatManager != null)
            {
				//ScratchSurfaceSprite = chatManager.GetComponent<ChatManager>().magnusPreferences.scratchCardFront[Random.Range(0, chatManager.GetComponent<ChatManager>().magnusPreferences.scratchCardFront.Length)];
