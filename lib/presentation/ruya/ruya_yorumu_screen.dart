...
const List<_Sembol> _semboller = [
  ...
  _Sembol('Kuş',
      ...
      'Bird',
      'A bird in a dream symbolizes freedom, hope and spiritual ascent. Flying birds symbolize your dreams and hopes — the higher they fly, the higher your goals are. A dead bird symbolizes the setback of your hopes or plans. If you hear birdsong, a new source of joy will enter your life.'),
  _Sembol('Kuyu',
      ...
      'Well',
      'A well in a dream is a window opening onto the depths of the subconscious and hidden truths. If you are looking into the well, there are deep questions within you for which you seek answers. If you are falling into the well, you are being dragged into emotions or a situation beyond your control. If you are drawing water from the well, you are pulling valuable insights and wisdom from your subconscious.'),
  _Sembol('Lamba',
      ...
      'Lamp',
      'A lamp in a dream symbolizes knowledge, understanding and guidance in the dark. A burning lamp shows that an understanding is approaching that will free you from the uncertainty you are in. A lamp going out symbolizes a loss of motivation or clarity. If you are the one lighting the lamp, you are beginning to trust your own inner wisdom.'),
  _Sembol('Mağara',
      ...
      'Cave',
      'A cave in a dream symbolizes withdrawal, protection and the secrets of the subconscious. If you are entering the cave, you are in a period where you need solitude and silence and want to return to yourself. If you are lost inside the cave, you are in the middle of a journey of self-discovery. If you are coming out of the cave, after a long period of introspection you are ready to reconnect with the world.'),
  _Sembol('Mektup',
      ...
      'Letter',
      'A letter in a dream symbolizes communication, awaited news and unspoken words. If you are receiving a letter, news or an answer you have long awaited is near. Writing a letter but being unable to send it shows that you are seeking an outlet for the emotions or words you hold inside. An unopened letter points to a truth in your life you have not yet accepted or faced.'),
  _Sembol('Melek',
      ...
      'Angel',
      'An angel in a dream is the symbol of divine guidance, protection and love. If the angel is speaking with you, it shows your subconscious wants to convey an important message — try to remember this message. If you see an angel protecting you, you feel that you are safe and have invisible support. This dream is a strong sign that you should not give up.'),
  _Sembol('Merdiven',
      ...
      'Stairs',
      'Stairs in a dream are the symbol of a process of progress, ascent or descent. If you are climbing the stairs, you are approaching your goals step by step and your direction is right. If you are descending, there is a lesson where you need to step back or be humble. If the stairs are broken or slippery, it reminds you that there are obstacles and points requiring caution on your journey.'),
  _Sembol('Mezar',
      ...
      'Grave',
      'A grave in a dream symbolizes closing chapters, letting go of the past and memories. If you see your own grave, it shows that an old version of you is now left behind; you have gone through a great transformation. If you are standing at the grave of someone familiar, you have unfinished business or unspoken words with that person. This dream allows you to grieve and let go.'),
  _Sembol('Mum',
      ...
      'Candle',
      'A candle in a dream symbolizes hope, remembrance and a strong light flickering in the dark. If you see a burning candle, it shows that the hope and faith you carry within are guiding you. If you are the one lighting the candle, you have the determination to advance even in a dark period. If the candle goes out, an inner process is beginning to accept that something or someone can no longer hold a place in your life.'),
  _Sembol('Müzik',
      ...
      'Music',
      'Music in a dream symbolizes emotional harmony, creativity and communication. If you hear beautiful music, it shows your inner world is enriching and you are in search of harmony. Grating sounds tell you to pay attention to a disharmony around you. If you are making music, there are powerful emotions within you waiting to be expressed and let out.'),
  _Sembol('Nazar',
      ...
      'Evil Eye',
      'The evil eye in a dream symbolizes jealousy, ill intent and negative energies coming from outside. If you feel you have been struck by the evil eye, the gazes or thoughts of others are affecting you too much. If you are wearing an evil-eye charm or it is given to you, you are in a state of needing protection and desiring safety. This dream reminds you to strengthen your energy boundaries.'),
  _Sembol('Nehir',
      ...
      'River',
      'A river in a dream symbolizes the flow of time, change and the natural course of life. A calm, clear river shows that your life has settled into a comfortable rhythm. A turbulent, muddy river symbolizes the feeling of losing control and resisting change. If you are crossing the river, it shows your determination in an important decision or transition process.'),
  _Sembol('Nişan',
      ...
      'Engagement',
      'An engagement in a dream symbolizes commitment, a promise and the union of two people or ideas. If you are getting engaged, it is a sign that you are ready for a stage of commitment in your relationship or life. If you see the engagement broken off, you are anxious and undecided about a commitment or promise. This dream invites you to question the true commitment in your heart.'),
  _Sembol('Okul',
      ...
      'School',
      'A school in a dream is the reflection of learning, exam anxiety and memories from the past. If you feel unprepared for an exam, it shows you are not ready for a situation in your life or carry a fear of being evaluated. If you see your old school, you need to remember a lesson or a person from the past. If you are teaching as a teacher, you have valuable knowledge and experiences you want to share.'),
  _Sembol('Orman',
      ...
      'Forest',
      'A forest in a dream symbolizes the complex labyrinth of the subconscious and the wild nature within. If you are lost, you feel you have lost your direction in life and are in need of guidance. If you are walking comfortably in the forest, you are at peace with complexity and trust your own strong intuition. If you are coming out of the forest, it heralds that the clutter in your mind or life will reach clarity.'),
  _Sembol('Oyun',
      ...
      'Game',
      'Playing a game in a dream symbolizes your longing for the fun sides of life and your free spirit. If you see childhood games, you miss a carefree and creative period. A game involving competition or the fear of losing reflects the pressure to succeed and prove your worth in real life. If you are enjoying the game, it tells you to nourish the lightness and joy in your life more.'),
  _Sembol('Ölüm',
      ...
      'Death',
      'Seeing death in a dream heralds not a real death but a great transformation. If you see your own death, it symbolizes that your old habits, beliefs or a life period are closing. If you see the death of a loved one, there is a great change in your relationship with this person or in an aspect they represent. This dream is the herald of a process of letting go and being reborn.'),
  _Sembol('Öpücük',
      ...
      'Kiss',
      'A kiss in a dream symbolizes love, approval and the desire to bond. If you receive a kiss from your beloved, you have a need for love and approval in this relationship, or you wish for mutual love to be confirmed. If you receive a kiss from a stranger, unexpected love or approval will come into your life. If you are kissing someone, you want to be more open and expressive in your relationships.'),
  _Sembol('Para',
      ...
      'Money',
      'Money in a dream symbolizes the need for power, value and security. If you find money, unexpected opportunities and material or emotional gains are at the door. If you lose money, you are feeling insecure and afraid of loss. If you are giving money to others, it is time to consider which is stronger — your generosity or your fear of being used.'),
  _Sembol('Pencere',
      ...
      'Window',
      'A window in a dream symbolizes your perspective on the outer world and future possibilities. If you are looking far away through an open window, new opportunities and freedom are calling you. A broken or closed window shows that you are limiting yourself or staying closed off to the beauties of life. If you are looking inside through a window, it is time to focus on your own life instead of observing the lives of others.'),
  _Sembol('Rüzgar',
      ...
      'Wind',
      'Wind in a dream symbolizes change, freedom and invisible forces. A harsh storm wind foretells great changes beyond your control. A light, sweet breeze tells you that the process you are in is natural and beautiful. If you feel the wind carrying you, it is time to surrender to the flow — do not resist, and let events guide you.'),
  _Sembol('Saç',
      ...
      'Hair',
      'Hair in a dream symbolizes power, identity and social image. Long, beautiful hair reflects confidence and charm; falling hair reflects identity anxiety or a feeling of losing control. If you are cutting your hair, it points to your readiness to let go of something old and renew yourself. If your hair is tangled and messy, mental and emotional fatigue is building up.'),
  _Sembol('Sarmaşık',
      ...
      'Ivy',
      'Ivy in a dream symbolizes both beauty and suffocating dependency. Ivy wrapping around you represents addictive or restrictive relationships. If you are tearing off the ivy, it shows you are gathering the courage to free yourself from an unhealthy bond. Ivy adorning a wall symbolizes attachment to the past and the strength of roots.'),
  _Sembol('Savaş',
      ...
      'War',
      'War in a dream symbolizes inner conflict, external struggle and situations requiring resistance. If you are in the war, you are battling a great force in your life or a contradiction within yourself. If you are watching the war from afar, the conflict of others affects you too but you are not directly in it. If you are winning victory, prevailing in a long-running struggle is near.'),
  _Sembol('Sel',
      ...
      'Flood',
      'A flood in a dream symbolizes the overflow of uncontrolled emotions and situations that are hard to overcome. If you are being swept along in the flood, emotions or events are drowning you and you cannot find direction. If you are escaping the flood from a high place, your instinct to keep a safe distance is working. If you see the destruction after the flood recedes, it symbolizes that a process of cleansing and rebuilding has begun.'),
  _Sembol('Su',
      ...
      'Water',
      'Water is one of the most fundamental elements in a dream, symbolizing the emotional world and the flow of life. Drinking clear, sweet water heralds energy, healing and clarity. Dirty or bitter water shows the need to purify yourself from emotional poisoning. If you are walking on water, you want to have control and power over your emotions.'),
  _Sembol('Şehir',
      ...
      'City',
      'A city in a dream symbolizes social life, crowds and the complexity of the outer world. A familiar but changed city reflects the difference between expectations and reality. A large city in which you are lost shows social pressure and a search for belonging. A beautiful, bright city is the herald of a productive and joyful period in your social connections.'),
  _Sembol('Şelale',
      ...
      'Waterfall',
      'A waterfall in a dream symbolizes freely flowing emotions, cleansing and renewal. Standing under a waterfall shows a need for deep purification and renewal. Watching a waterfall from afar means you want beauty and freedom but cannot yet reach them. Swimming in waterfall water is a strong step in the process of emotional honesty and being at peace with yourself.'),
  _Sembol('Şimşek',
      ...
      'Lightning',
      'Lightning in a dream is a sign of sudden enlightenment, unforeseen change and powerful energy. If you fear the lightning, the sudden changes in your life unsettle you. But if you watch the lightning and are mesmerized, your moments of creative power and insight are increasing. If you feel the lightning illuminate you, the answer to a question you have long sought will flash.'),
  _Sembol('Taş',
      ...
      'Stone',
      'A stone in a dream symbolizes endurance, weight or immobility. If you are carrying a heavy stone, there is a burden or responsibility on your shoulders you cannot shake off. If you feel yourself turning to stone, it shows you have become emotionally numb or are starting to be too rigid in your life. If you find a beautiful stone, there are valuable lessons and strength you have drawn from the hardships of your life.'),
  _Sembol('Tren',
      ...
      'Train',
      'A train in a dream symbolizes the rhythm of life, goal-oriented progress and missed opportunities. If you are missing the train, you are anxious about overlooking an opportunity or being late. If you are on the train going fast, your life has gained strong momentum and events are sweeping you along. If you are watching the train, you feel that others are advancing while you are pausing.'),
  _Sembol('Tünel',
      ...
      'Tunnel',
      'A tunnel in a dream symbolizes passage through a dark period and the hope of reaching the light. If you are walking inside the tunnel, you are right in the middle of a tough process but there is light at the end. If you see the light at the end of the tunnel, you will soon reach the way out of your current difficulties. If you are lost in the tunnel, the feeling of uncertainty and being unable to find a way out is dominant.'),
  _Sembol('Uçmak',
      ...
      'Flying',
      'Flying is one of the most beautiful experiences in a dream, symbolizing freedom, surpassing limits and the infinity of possibilities. If you are flying with your arms, it shows you will rise by your own power without anyone\'s help. If you are afraid while flying, you have a desire for freedom and ascent but something is holding you back. If you are descending while flying, you are experiencing a loss of motivation or confidence — but you can fly again.'),
  _Sembol('Uçurum',
      ...
      'Cliff',
      'A cliff in a dream symbolizes standing at the edge of great risks, limits and infinite possibilities. If you are standing at the edge of the cliff, you are at the threshold of a big decision or risk. If you are jumping off the cliff, you are ready to take a great step whose outcome is uncertain but which will bring transformation. If you are falling off the cliff, it symbolizes the fear of losing control and the feeling of the ground beneath your feet shaking.'),
  _Sembol('Üzüm',
      ...
      'Grape',
      'A grape in a dream symbolizes abundance, pleasure and the time to harvest the fruits of your labor. Picking fresh, ripe grapes heralds that you are about to see the reward of long effort. Unripe grapes are a warning about the early conclusion of a not-yet-matured project or relationship. If you are eating grapes, it is time to appreciate the small pleasures of life and savor the present.'),
  _Sembol('Volkan',
      ...
      'Volcano',
      'A volcano in a dream symbolizes that long-suppressed emotions and energy are ready to erupt. If you are watching the volcano erupt, a great and uncontrollable force is at work around or within you. If you see the lava flowing toward you, the anger or passion of others is threatening you. If you are standing on the summit of the volcano, you are right on top of a great source of power and energy.'),
  _Sembol('Yıldız',
      ...
      'Star',
      'A star in a dream symbolizes hope, inspiration and dreaming big. Shining stars represent the potential and life energy within you. If you see a shooting star and make a wish, your subconscious is reminding you to believe in your dreams. If you see the stars going out, it shows you are in the process of accepting that an ideal or dream is not realistic.'),
  _Sembol('Yılan',
      ...
      'Snake',
      'A snake in a dream is one of the powerful messages of transformation, healing and the subconscious. A snake attacking you represents a manipulative or toxic relationship or a fear in your life. If you see a peaceful or harmless snake, you are at the start of a great process of transformation and renewal. If the snake is shedding its skin, it symbolizes that you too are shedding your old patterns and renewing yourself.'),
  _Sembol('Yolculuk',
      ...
      'Journey',
      'A journey in a dream symbolizes the process of life and your steps on the road to your goals. If you are walking on a long road, it shows you are walking step by step toward a great aim and that the process itself is valuable. If you are losing your way, you are in a period where you struggle to set direction and feel confused. If you are reaching the end of the journey, you are about to complete an important cycle.'),
  _Sembol('Yük',
      ...
      'Burden',
      'A burden in a dream symbolizes the responsibilities you carry, your stress and the weights you receive from others or take on yourself. If you are carrying a very heavy load, the responsibilities piling on you are crushing you. If you are setting the load down, it shows you are ready to release a responsibility or worry you have carried for a long time. If there is someone helping you carry the load, real support and solidarity are present in your life.'),
  _Sembol('Yüz',
      ...
      'Face',
      'A face in a dream symbolizes identity, relationships with others and wearing a social mask. If you see a familiar face, there is a strong bond or unresolved emotions continuing with that person in your subconscious. If you see your face changing, you are in a deep questioning of who you are or how you appear. Seeing a beautiful, bright face is the herald of growing self-respect and love.'),
  _Sembol('Yüzmek',
      ...
      'Swimming',
      'Swimming in a dream symbolizes coping with emotions and the ability to carry yourself through life. If you are swimming easily in clear water, you are emotionally healthy and free. If you are drowning or sinking from exhaustion, emotional burden and stress are overwhelming you — it is time to seek help. If you are swimming in deep water, you are bravely facing complex emotions.'),
  _Sembol('Zincir',
      ...
      'Chain',
      'A chain in a dream symbolizes restriction, dependency and obstacles before freedom. If you are bound by a chain, you feel that a relationship, habit or situation is limiting you. If you are breaking the chain, it is a sign that your liberation from something that has held you for a long time is near. If you are chaining someone else, it is time to honestly reflect on the need to control or hold on.'),
  _Sembol('Zombi',
      ...
      'Zombie',
      'A zombie in a dream symbolizes emotional numbness, mechanical living and questioning whether you are alive. If you are running from zombies, you fear being influenced or pulled in by the unconsciously drifting crowd. If you feel yourself to be a zombie, the time has come to add real meaning and enthusiasm to your life. This dream asks you the question, "Are you truly living?"'),
];
