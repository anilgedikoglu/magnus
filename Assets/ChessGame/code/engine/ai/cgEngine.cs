...
public class cgEngine 
{
    ...
    public DateTime _engineOperationStartTime;
    public float _minMoveDelay;
    ...
    {
        while (timeSinceStart.Seconds < _minMoveDelay)
        {
            timeSinceStart = DateTime.Now.Subtract(_engineOperationStartTime);
            yield return null;
        }
