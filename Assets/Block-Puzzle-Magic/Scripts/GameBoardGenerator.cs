...
public class GameBoardGenerator : Singleton<GameBoardGenerator>
{
	...
	public void GenerateBoard ()
	{
		...
		{
			//Eger kayit varsa ve kullanici kayittan devam etmek istiyorsa kaydi aliyoruz.
			if (FindObjectOfType<CurrentPlayerData>().GetChatVariableValue("magnutris kaldigi yerden devam") != "evet")
