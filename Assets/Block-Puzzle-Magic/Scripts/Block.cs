...
public class Block : MonoBehaviour 
{
	...
	void OnEnable()
	{
		firstColor = transform.GetComponent<Image>().color;
	...
	{
		transform.GetComponent<Image> ().color = new Color (firstColor.r, firstColor.g, firstColor.b, 0);
		#if HBDOTween
		...
		transform.GetComponent<Image> ().DOFade (firstColor.a, 0.35F).SetDelay (0.3F);
