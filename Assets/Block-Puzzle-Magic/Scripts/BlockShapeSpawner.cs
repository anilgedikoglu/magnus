...
public class BlockShapeSpawner : Singleton<BlockShapeSpawner> 
{
	...
	void Start()
	{
		...
		Invoke ("SetupPreviousSessionShapes", 2.2F);
		Invoke ("createShapeBlockProbabilityList", 2.5F);
		Invoke ("FillShapeContainer", 2.5F);
	}
	...
	public void AddRandomShapeToContainer(Transform shapeContainer)
	{
		...
		spawningShapeBlock.transform.localScale = Vector3.one * 0.75F;
